...
const ArticleEditor = () => {
    ...
    return (
        <div style={{ width: '80%', margin: '0 auto' }}>
            ...
            <button onClick={handleSave}  className='green-button' style={{margin:'10px 20px'}}>Save Article</button>
            <button onClick={goBack}  className='green-button' style={{margin:'10px 20px'}}>Go Back</button>
        </div>
    );
};
